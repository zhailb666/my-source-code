...
var f1 = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, setTimeout(function () { console.log(3); })];
            case 1:
                _a.sent();
...
export default (function (initialState, options) {
    var _a = (options || {}).navigateMode, navigateMode = _a === void 0 ? 'push' : _a;
    var location = useLocation();
    var history = useHistory();
    var _b = __read(useState(false), 2), update = _b[1];
    ...
    var targetQuery = useMemo(function () { return (__assign(__assign({}, initialStateRef.current), queryFromUrl)); }, [queryFromUrl]);
